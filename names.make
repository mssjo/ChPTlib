...
ifdef KALPAR
    NAMESUFFIX := $(NAMESUFFIX)_KALPAR
    FORMOPTS := $(FORMOPTS) -d KALPAR
    MAKEOPTS := $(MAKEOPTS) KALPAR=1
endif
ifdef GENPAR
    NAMESUFFIX := $(NAMESUFFIX)_GENPAR
    FORMOPTS := $(FORMOPTS) -d GENPAR
    MAKEOPTS := $(MAKEOPTS) GENPAR=1
endif
ifdef TRF
