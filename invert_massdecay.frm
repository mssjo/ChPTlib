* Auxiliary program to ChPTlib, used by ChPT_renorm.hf
*
* This file inverts the relation between renormalized and unrenormalized
* mass and decay constant, since the way it is derived (Mpi/Fpi in terms of M/F)
* is opposite to the way it is used (reexpressing M/F in terms of Mpi/Fpi).
*
* This generates invert_massdecay.hf, and needs to be extended and rerun
* if including higher orders or more complicated ChPT variants
